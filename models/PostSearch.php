...
class PostSearch extends Post
{
    ...
    {
        $query = Post::find()->where(['status_id' => Status::getStatus('Одобрен')])->with(['theme0', 'reactions' => function ($query) {
    ...
    {
        $query = Post::find()->where(['status_id' => Status::getStatus('Одобрен')])->with(['theme0', 'user'])->orderBy(['created' => SORT_DESC])->limit(10);
